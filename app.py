...
CATALOG = [
    {"id": "01", "cat": 1, "name": "카카오톡 이모티콘 구매권", "cost": 2500, "emoji": "💬",
     "desc": "카톡을 더 귀엽게! 좋아하는 이모티콘을 직접 골라 받을 수 있어요."},
    {"id": "02", "cat": 1, "name": "네이버페이 포인트 쿠폰 (5,000원권)", "cost": 5000, "emoji": "💳",
     "desc": "네이버페이로 어디서나 현금처럼 쓸 수 있는 5,000원 포인트.", "real": 5000},
    {"id": "03", "cat": 1, "name": "구글 기프트코드 (15,000원권)", "cost": 15000, "emoji": "🎟️",
     "desc": "앱·게임·구독 결제에 쓰는 구글 기프트코드.", "real": 15000},
    {"id": "04", "cat": 1, "name": "문화상품권 (20,000원권)", "cost": 20000, "emoji": "🎫",
     "desc": "온·오프라인 어디서나 통하는 만능 문화상품권.", "real": 20000},
    {"id": "05", "cat": 1, "name": "도서문화상품권 (50,000원권)", "cost": 50000, "emoji": "📚",
    ...
    {"id": "10", "cat": 2, "name": "죠스떡볶이 1인 세트", "cost": 6500, "emoji": "🍢",
     "desc": "학원 가기 전 출출함을 달래는 매콤한 분식 세트."},
    {"id": "11", "cat": 2, "name": "맘스터치 싸이버거 세트", "cost": 6900, "emoji": "🍔",
     "desc": "든든한 한 끼! 청소년 선호도 높은 싸이버거 세트."},
    {"id": "12", "cat": 2, "name": "BHC 뿌링클 + 콜라 세트", "cost": 23000, "emoji": "🍗",
     "desc": "주말에 온 가족이 함께! 부모님께 대접하는 뿌듯한 치킨 세트."},
    {"id": "13", "cat": 3, "name": "고기능성 스터디 플래너", "cost": 5000, "emoji": "📔",
     "desc": "스스로 학습 계획을 세우는 중1 시기에 딱 맞는 플래너."},
    {"id": "14", "cat": 3, "name": "프리미엄 필기구 세트", "cost": 10000, "emoji": "🖊️",
     "desc": "캐릭터 협업 디자인의 소장 가치 높은 고급 샤프·펜 세트."},
    {"id": "15", "cat": 3, "name": "각도 조절 디자인 독서대", "cost": 12000, "emoji": "📖",
     "desc": "인강·독서 시 거북목을 막아주는 실용 독서대.", "real": 12000},
    {"id": "16", "cat": 3, "name": "스터디 텀블러 (보온·보냉)", "cost": 20000, "emoji": "🥤",
     "desc": "책상 위에 두고 쓰는 깔끔한 디자인의 개인 텀블러.", "real": 20000},
    {"id": "17", "cat": 4, "name": "인기 캐릭터 그립톡·파우치", "cost": 15000, "emoji": "🩷",
     "desc": "스마트폰을 나만의 개성으로! 취향 저격 꾸미기 아이템."},
    {"id": "18", "cat": 4, "name": "무선 무소음 마우스", "cost": 15000, "emoji": "🖱️",
     "desc": "과제·인강에 유용한, 독서실에서도 조용한 무소음 마우스."},
    {"id": "19", "cat": 4, "name": "인기 보드게임", "cost": 25000, "emoji": "🎲",
     "desc": "화면 밖에서 친구·가족과 즐기는 두뇌 보드게임 (루미큐브 등)."},
    {"id": "20", "cat": 4, "name": "블루투스 무선 이어폰", "cost": 50000, "emoji": "🎧",
